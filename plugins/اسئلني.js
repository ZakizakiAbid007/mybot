// لضمان التنسيق الجمالي، يجب أن تكون محددة في ملفك الرئيسي أو يمكنك تعريفها هنا بشكل مبسط
// *افتراض* وجود ثيم بسيط للتنسيق
const theme = {
    border: {
        start: '╭━━━━━━\n┃',
        end: '╰━━━━━━'
...
let handler = async (m, { conn }) => {
    // اختيار سؤال عشوائي
    const randomQuestion = pickRandom(global.bucin);

    // استخدام تنسيق أكثر تنظيماً
    let caption = `
${theme.border.start} *سـؤال عـشـوائـي* ${theme.emojis.main}
┃
┃ *“${randomQuestion}”*
┃
${theme.border.end}
${theme.emojis.footer} *أجـب بـصـدق* ${theme.emojis.footer}
`.trim();
...
// دالة اختيار عشوائي (موجودة في الكود الأصلي)
function pickRandom(list) {
    return list[Math.floor(list.length * Math.random())]
}

// ⭐ القائمة العالمية للأسئلة (global.bucin) ⭐
// يُفضل وضع هذه القائمة في ملف التكوين العام (مثل config.js) لتسهيل إدارتها،
// ولكن سأبقيها هنا كما طلبت:
global.bucin = [ 
