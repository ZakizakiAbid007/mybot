...
handler.help = ['ضف_كود', 'ضف_امر'] // تعليمات المساعدة للأوامر الجديدة
handler.tags = ['owner']
// تم تعطيل البادئة المخصصة (Custom Prefix) للاعتماد على أمر صريح
// handler.customPrefix = /^=?> / 
handler.command = ['ضف_كود', 'ضف_امر'] // الأوامر الجديدة
handler.rowner = true
